...
(function(window, undef) {
  ...
  var
    ...
    html5 = !!(File && (FileReader && (window.Uint8Array || FormData || XMLHttpRequest.protocol.sendAsBinary))) && !(safari && /windows/i.test(userAgent) && !iemobile), // BugFix: https://github.com/mailru/FileAPI/issues/25

    cors = html5 && ('withCredentials' in (new XMLHttpRequest)),

    chunked = html5 && !!Blob && !!(Blob.protocol.webkitSlice || Blob.protocol.mozSlice || Blob.protocol.slice),
